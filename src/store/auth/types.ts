...
import { DataCollectionField, DynamicListItem, Checkpoint } from '../setting/types';
...
export enum AuthActionTypes {
  ...
  UPDATE_QUESTIONNARE = 'update_questionnaire',
  ...
  ENROLLMEET = 'enroll_meet',
  WHEALTH_CONCIERGE_MEET = 'whealth_concierge_meet',
  ADVISOR_MEET = 'advisor_meet',
  ...
  ADD_DOCUMENT_PROFILE = 'ADD_DOCUMENT_PROFILE',
  ADD_DOCUMENT = 'ADD_DOCUMENT',
  UPDATE_PROFILE_STEP = 'UPDATE_PROFILE_STEP',
  INTRO_USER = 'INTRO_USER',
  CLEAR_INTRO_USER = 'CLEAR_INTRO_USER'
}
