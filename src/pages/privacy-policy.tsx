							...
							<ul className="list-disc marker:text-[#FAA942] pb-[32px] pl-6">
								...
								<li className="text-[#5A6478] text-[18px] leading-[30px] pb-[12px]">
									...
									<a
										...
										target="_blank"
										className="text-transparent bg-clip-text bg-gradient-to-br from-[#3F68E4] to-[#5EC4F7] underline" rel="noreferrer"
									>
						...
						<div className="pt-[60px]" id="section_9">
							...
							<div className="text-[18px] text-[#5A6478] leading-[30px] pb-[20px]">
								...
								<a
									...
									target="_blank"
									className="text-transparent bg-clip-text bg-gradient-to-br from-[#3F68E4] to-[#5EC4F7] underline break-all md:break-normal" rel="noreferrer"
								>
