...
const Blog: React.FC = (props) => {
    ...
    return (
        <div className="w-full bg-[#F7F9FC]">
            ...
            {hero && (
                <div
                    className={`relative w-full bg-hero-texture-mobile lg:bg-blog-hero-texture bg-cover bg-bottom bg-no-repeat px-6 lg:px-[0] ${
                ...
                <div className="w-full bg-[#fff]">
                    <div className="flex flex-col md:flex-row md:h-[78px] items-center py-[10px] lg:py-[0] gap-y-[10px] w-[calc(100%-48px)] lg:max-w-[960px] xl:max-w-[1280px] mx-auto justify-between">
                        {blog.categories.map((item, index) => (
                            <div
                                className={`flex items-center group gap-x-[4px] text-[16px] leading-[24px] xl:text-[18px] xl:leading-[30px] relative cursor-pointer transition duration-300 hover:text-[#3F68E4] ${
                                    filter === item.value
