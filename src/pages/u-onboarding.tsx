    ...
    onSubmit: (value: Dima) => {
      ...
      Object.keys(documents).map((key) => {
        Object.keys(documents[key]).map((fileKey, index) => {
          formdata.append(`${key}[${index}]`, documents[key][fileKey])
        })
      })
      ...
      <div>
        ...
        <div className="mt-28">
          ...
          >
            ...
            <div className="w-full mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="DOB" className="w-full text-md text-blue-700">
                  Date Of Birth
                </label>
                <InputMask
                  mask="99/99/9999"
              ...
              <div>
                <label htmlFor="DOB2" className="w-full text-md text-blue-700">
            ...
            <div className="w-full mb-4">
              <label htmlFor="email" className="w-full text-md text-blue-700">
                Email
              </label>
              <div className="w-full text-gray-400 text-sm">
                this email is considered your client id#, please use the same
                email for all forms and communication.
              </div>
              <input
                type="text"
                className="w-full mt-1 bg-[#f5f8fa] border border-[#cbd6e2] px-[10px] text-base text-[#33475b] h-10 outline-none rounded-sm"
            ...
            <div className="w-full mb-4">
              <label htmlFor="address" className="w-full text-md text-blue-700">
                Street Address
              </label>
              <input
                type="text"
            ...
            <div className="w-full mb-4 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label htmlFor="city" className="w-full text-md text-blue-700">
                  City
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="state" className="w-full text-md text-blue-700">
                  State
                </label>
                <input
                  type="text"
