...
const Princing: React.FC = (props: any) => {
    ...
    const handleCouponChange = (e) => {
        if (e.target.value == "") couponChanged = false;
        else couponChanged = true;
    };
    ...
    useEffect(() => {
        if (stripe) {
            ...
            pr.on("paymentmethod", async (e) => {
                dispatch(
                    createSubscription(e.paymentMethod.id, couponData?.id)
                );
            });
        }
    }, [stripe, couponData]);
