...
const Documents: React.FC = () => {
  ...
  const handleUpdateDocument = () => {
    ...
    let updatedFileName = document.getElementById(`filename-${editable}`)
      ?.innerText
    if (updatedFileName != '') {
      setEditable(false)
              ...
              <div className="text-black flex text-base md:text-xl gap-[6px] leading-8 font-normal">
                ...
                >
                  <span className="bg-underline-text bg-no-repeat bg-underline-text-size bg-bottom">
                    {isMobile ? 'Upload your file' : 'Browse files'}
                  </span>
                </div>
              </div>
            </div>
              ...
              <>
                <ContextMenuTrigger id={`contextmenu-${key}`}>
                  ...
                  >
                    ...
                    >
                      <Image src="/assets/images/document.svg" alt="document" />
                      <span
                        ...
                        onBlur={() => {
                          if (editable === key) handleUpdateDocument()
                        }}
                      >
                        {editable === key
