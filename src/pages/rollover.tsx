...
import BeneFiciary, {
  BeneficiaryType,
} from '@/components/Pages/RolllOver/Beneficiary'
    ...
    onSubmit: (value: FormData, { resetForm }) => {
      ...
      axios.post('rollover', submitData).then(({ data }) => {
        ...
        if (data.success) {
          ...
          location.href = 'https://meetings.hubspot.com/ms7/simple-rollover'
        } else {
    ...
    >
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="w-full mb-4 p-2">
          <div className="w-full flex flex-cols-1 md:flex-cols-2 gap-4">
            <div className="w-full mb-4">
              ...
              {formik.touched.firstname && formik.errors.firstname && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.firstname}</div>
                </div>
              )}
            </div>
            ...
            <div className="w-full mb-4">
              ...
              {formik.touched.lastname && formik.errors.lastname && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.lastname}</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="w-full flex flex-cols-1 md:flex-cols-2 gap-4">
            ...
            <div className="w-full mb-4">
              ...
              {formik.touched.phoneNumber && formik.errors.phoneNumber && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.phoneNumber}</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="w-full flex flex-cols-1 md:flex-cols-2 gap-4">
            <div className="w-full mb-4">
              ...
              {formik.touched.streetAddress && formik.errors.streetAddress && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.streetAddress}</div>
                </div>
              )}
            </div>
            <div className="w-full mb-4">
              ...
              {formik.touched.streetAddress2 && formik.errors.streetAddress2 && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.streetAddress2}</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="w-full flex flex-cols-1 md:flex-cols-3 gap-4">
            <div className="w-full mb-4">
              ...
              {formik.touched.city && formik.errors.city && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.city}</div>
                </div>
              )}
            </div>
            ...
            <div className="w-full mb-4">
              ...
              {formik.touched.state && formik.errors.state && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.state}</div>
                </div>
              )}
            </div>
            ...
            <div className="w-full mb-4">
              ...
              {formik.touched.zipCode && formik.errors.zipCode && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.zipCode}</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="w-full mb-4">
            <label className="w-full text-md mb-1 text-blue-600" htmlFor="DOB">
              Date Of Birth
            </label>
            <InputMask
              mask="99/99/9999"
          ...
          <div className="w-full flex flex-cols-1 md:flex-cols-3 gap-4">
            <div className="w-full mb-4">
              ...
              >
                ...
                <option label="Business Owner" value="Business Owner">
                  Business Owner
                </option>
            ...
            <div className="w-full mb-4">
              ...
              {formik.touched.employer && formik.errors.employer && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.employer}</div>
                </div>
              )}
            </div>
            ...
            <div className="w-full mb-4">
              ...
              {formik.touched.occupation && formik.errors.occupation && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.occupation}</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="w-full flex flex-cols-1 md:flex-cols-2 gap-4">
            <div className="w-full mb-4">
              ...
              {formik.touched.netWorth && formik.errors.netWorth && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.netWorth}</div>
                </div>
              )}
            </div>
            <div className="w-full mb-4">
              ...
              {formik.touched.liquidNetWorth && formik.errors.liquidNetWorth && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.liquidNetWorth}</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="w-full flex flex-cols-1 md:flex-cols-2 gap-4">
            <div className="w-full mb-4">
              ...
              <NumericFormat
                ...
                placeholder="$0.00"
                className="w-full rounded-sm h-10 border border-solid border-[#b3bdc1] bg-[#87c4eb1c] outline-none px-2"
                {...formik.getFieldProps('estimatedAnnualIncome')}
              />
        ...
        <div className="w-full mb-4 p-2">
          <div className="w-full mb-4">
            ...
            ></input>
            {formik.touched.numberOfAccounts && formik.errors.numberOfAccounts && (
              <div className="w-100 text-red-500">
                <div className="w-100">{formik.errors.numberOfAccounts}</div>
              </div>
            )}
          </div>
          ...
          <div className="w-full flex flex-cols-1 md:flex-cols-3 gap-4">
            <div className="w-full mb-4">
              ...
              >
                ...
                <option value="Qualified Plan">Qualified Plan</option>
                <option value="Other">Other</option>
              </select>
              {formik.touched.accountTypes && formik.errors.accountTypes && (
                <div className="w-100 text-red-500">
                  <div className="w-100">{formik.errors.accountTypes}</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="w-full">
            This section includes a few questions that are required for the
            successful completion of your appliation
          </div>
        </div>
