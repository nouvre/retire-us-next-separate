...
const Support: React.FC = (props: any) => {
  ...
  useEffect(() => {
    axios
      .get(`https://app.hubspot.com/api-passthrough/meetings-public/v1/book`, {
        params: {
          slug: slugs[0],
          now: Date.now(),
          ...
          <div className="flex flex-col lg:flex-row gap-[24px]">
            <div className="flex-1">
              ...
              <TextNormal grayed className="mb-[20px] md:mb-[32px]">
                Wealth Concierge is a dedicated team of professionals designed
                to maximize your virtual planning experience and seamlessly help
                your financial plan operate.
              </TextNormal>
            ...
            <div className="flex flex-col lg:flex-row gap-[24px]">
              {teamMembers.map((tm, idx) => (
                ...
                >
                  ...
                  <div className="">
                    <TextNormal className="font-bold">{tm.name}</TextNormal>
              ...
              <div className="w-full md:flex-1 flex flex-col bg-white px-[20px] py-[20px] md:px-[24px] md:py-[24px] rounded-[20px] gap-[20px]">
                <TextNormal className="font-bold">Contact Us</TextNormal>
                <div className="mt-auto">
                  <div className="flex flex-wrap item-center pb-3">
                    <Image
                      ...
                      className="mr-2"
                    />
                    <div className="text-base md:text-lg mr-4">Email:</div>
                  ...
                  <div className="flex flex-wrap item-center pb-3">
                    <Image
                      ...
                      className="mr-2"
                    />
                    <div className="text-base md:text-lg mr-2">Phone:</div>
                    <TextGradient className="text-base md:text-lg">
                      1-800-857-PLAN
                    </TextGradient>
                  </div>
