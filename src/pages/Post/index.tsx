        ...
        async function getCmsData() {
            ...
            if (!content.posts) {
                ...
                const exactPost = content.posts.find((item: Post) => {
                    if (params.slug === item.attributes.url) return item;
                });
        ...
        <div className="w-full">
            <Helmet
                ...
                link={[
                    {
                        rel: "canonical",
                        href: `https://retire.us/blog/${params?.slug}`,
                    },
                ]}
            />
                        ...
                        <div className="w-[calc(100%-48px)] lg:max-w-[840px] mx-auto">
                            ...
                            <div className="flex flex-col lg:flex-row justify-between pt-[12px]">
                                ...
                                <div className="flex items-center gap-x-[24px] lg:gap-x-[20px] mt-[12px] pt-[12px] border-t-[1px] border-[#DDE3F0] md:mt-[0] md:pt-[0] md:border-t-[0px]">
                                    ...
                                    <a
                                        href={`https://twitter.com/intent/tweet?url=https://retire.us/blog/${params.slug}&text=${post.attributes?.description}`}
                                        target="_blank"
                                    ...
                                    <a
                                        href={`https://www.linkedin.com/sharing/share-offsite/?url=https://retire.us/blog/${params.slug}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        <Image
                                    ...
                                    <a
                                        href={`https://www.facebook.com/sharer/sharer.php?u=https://retire.us/blog/${params.slug}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        <Image
