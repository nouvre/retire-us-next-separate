    ...
    <AdminLayout>
      ...
      >
        <div className="w-[14rem] flex flex-none justify-between flex-col gap-1 p-5 py-10">
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'Questionnaire' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
          ...
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'Planning' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
          ...
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'Flags' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
          ...
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'Documents' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
          ...
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'todo' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
          ...
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'dynamicList' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
          ...
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'Goal' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
          ...
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'quickView' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
          ...
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'Assign' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
          ...
          <div
            className={`w-full flex items-center justify-start p-[10px] py-1 gap-3 rounded-xl cursor-pointer ${curItem == 'idInfo' ? 'bg-white bg-opacity-20' : null
              }`}
            onClick={() =>
