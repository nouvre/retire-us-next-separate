...
export const questionAnswers: Question[] = [
  ...
  {
    title:
      "By our math, it sounds like you want to retire in :wantedYear: years. Does that sound right to you?",
    answers: [
      {
  ...
  //6-2     index: 7
  {
    ...
    answers: [
      {
        title:
          "I’m not sure how much I should be saving each month to stay on track",
  ...
  {
    title:
      "What other financial goals could impact retirement? (select all that apply)",
    answers: [
      {
  ...
  {
    title:
      "Have you considered the tax implications of your retirement savings?",
    answers: [
      {
  ...
  {
    title:
      "How would you feel if you had to pay more taxes during retirement than you do right now?",
    answers: [
      {
  ...
  {
    title:
      "Do you know what your portfolio would lose in the event of a market crash?",
    answers: [
      {
  ...
  {
    title:
      "Is retirement in :year: years something that you seriously want to accomplish?",
    answers: [
      {
...
export const HEAD_DATA = [
  ...
  },
  {
    ...
    data: {
      ...
      meta: [
        {
          name: "description",
          content:
            "Our mission is to help you establish a clear path to financial freedom through time-saving technology and easier access to expert advice.",
        },
        {
          name: "keywords",
          content:
      ...
      link: [{ rel: "canonical", href: "https://retire.us/about-us" }],
    },
  },
  {
    name: "OurServices",
  ...
  },
  {
    ...
    data: {
      ...
      link: [{ rel: "canonical", href: "https://retire.us/get-started" }],
    },
  },
  {
    name: "Pricing",
    data: {
      ...
      link: [{ rel: "canonical", href: "https://retire.us/pricing" }],
    },
  },
  {
    name: "Planning",
    data: {
      ...
      link: [
        { rel: "canonical", href: "https://retire.us/our-planning-process" },
      ],
    },
  },
  {
      ...
      meta: [
        {
          name: `description`,
          content:
            "Sign Up for a RetireUS account. Retirement and financial planning. Trusted and Certified Financial Planners at your fingertips.",
        },
      ],
      link: null,
    },
